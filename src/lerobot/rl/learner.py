...
def start_learner_threads(
    ...
    Args:
        ...
        experiment_logger: Logger for metrics (ExperimentLogger or None)
...
def add_actor_information_and_train(
    ...
    Args:
        ...
        experiment_logger: Logger for tracking training progress (ExperimentLogger or None).
    ...
    while True:
        ...
        if optimization_step % log_freq == 0:
            ...
            if experiment_logger:
                experiment_logger.log_dict(d=training_infos, mode="train", custom_step_key="Optimization step")
...
def process_interaction_message(
    message, interaction_step_shift: int, experiment_logger=None
):
    ...
    if experiment_logger:
        experiment_logger.log_dict(d=message, mode="train", custom_step_key="Interaction step")
...
def process_interaction_messages(
    ...
    Args:
        ...
        experiment_logger: Logger for tracking progress (ExperimentLogger or None)
        shutdown_event: Event to signal shutdown
